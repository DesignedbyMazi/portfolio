...
export default function IntroCopy() {
  return (
    <div className="intro">
      ...
      <p className="intro__para" data-animate data-delay="60">
      ...
      <p className="intro__para" data-animate data-delay="120">
      ...
      <p className="intro__para" data-animate data-delay="180">
      ...
      <p className="intro__para" data-animate data-delay="240">
