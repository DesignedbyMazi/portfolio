...
export default function IntroCopy() {
  return (
    <div className="intro">
      ...
      <p className="intro__para" data-animate data-delay="80">
      ...
      <p className="intro__para" data-animate data-delay="160">
      ...
      <p className="intro__para" data-animate data-delay="320">
